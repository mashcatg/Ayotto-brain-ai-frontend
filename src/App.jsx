...
function App() {
  ...
  const handleGenerate = async () => {
    ...
    reader.onloadend = async () => {
      ...
      6. Reference text can be inside [](e.g.: [ঢা. বি. ২০২৪-২৫] or [ঢাকা নটরডেম কলেজ, রাজশাহী সরকারি পাবলিক স্কুল] etc). Also, solutionText can be inside ব্যাখ্যা/Solution/Solve or any similar part(It might be the bottom of the question).
